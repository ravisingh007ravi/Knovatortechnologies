...
const {createUser, logInUserData, getUserData} = require("../controller/userController.js");
const { authentication, authorization, checkuserId } = require("../middleware/auth.js");
const {createProducts, getProductsData, getProductsDataById, updateProductData, deleteProductData,ProductData } = require("../controller/productcontroller");
...
router.put("/user/:userId/profile", authentication, authorization, checkuserId);
